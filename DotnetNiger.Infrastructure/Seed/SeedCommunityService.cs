...
public static class SeedCommunityService
{
    ...
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        SeedProjectsPartnersSettings(db, now);

        await db.SaveChangesAsync();
        Console.WriteLine("   Community: seed complete.");
    }

    static (List<Category>, List<Tag>) SeedBase(DotnetNigerDbContext db)
    {
    ...
    static void SeedProjectsPartnersSettings(DotnetNigerDbContext db, DateTime now)
    {
        SeedCommunityContentService.SeedProjectData(db, now);
        SeedCommunityContentService.SeedPartnerData(db, now);
    }
}