...
public class EventsControllerTests
{
    ...
    public async Task GetAll_ReturnsOk()
    {
        ...
        svc.Setup(x => x.GetAllAsync(null, null, null, null, null, null, null, null, 1, 10, null))
        ...
        var result = await ctrl.GetAll(null, null, null, null, null, null, null, null, 1, 10, null);
