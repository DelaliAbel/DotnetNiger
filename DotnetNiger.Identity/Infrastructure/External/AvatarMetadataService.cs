...
public class AvatarMetadataService : IAvatarMetadataService
{
    ...
    public async Task<AvatarInfoResponse> GetMetadataAsync(string? avatarUrl)
    {
        var hasAvatar = !string.IsNullOrWhiteSpace(avatarUrl);
        var result = new AvatarInfoResponse
        {
    ...
    private AvatarInfoResponse GetLocalMetadata(AvatarInfoResponse result)
    {
    ...
    private async Task<AvatarInfoResponse> GetAzureMetadataAsync(AvatarInfoResponse result)
    {
