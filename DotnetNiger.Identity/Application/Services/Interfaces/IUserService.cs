...
public interface IUserService
{
	...
	Task<UserDto> UpdateAvatarAsync(Guid userId, string avatarUrl, CancellationToken ct = default);

	// Suppression de l'avatar utilisateur.
	Task<UserDto> ClearAvatarAsync(Guid userId, CancellationToken ct = default);
