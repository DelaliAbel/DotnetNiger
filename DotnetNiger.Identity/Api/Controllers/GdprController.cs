...
/// <summary>Gestion RGPD : consentements, export et effacement.</summary>
[ApiController]
[ApiVersion("1.0")]
...
public class GdprController : ControllerBase
{
    ...
    /// <summary>Enregistre un consentement.</summary>
    [HttpPost("consent")]
    ...
    /// <summary>Récupère les consentements (dernier par type).</summary>
    [HttpGet("consent")]
    ...
    /// <summary>Exporte les données personnelles (ZIP).</summary>
    [HttpGet("data")]
    ...
    /// <summary>Anonymise les données (droit à l'effacement).</summary>
    [HttpPost("forget-me")]
