...
public class OpenIddictManagementService
{
    ...
    public OpenIddictManagementService(DotnetNigerDbContext db) => _db = db;
    ...
    public async Task<string> BootstrapWebUiAsync(IOpenIddictApplicationManager appManager, string frontendBaseUrl)
    {
        ...
        if (existing != null)
        {
            ...
            descriptor.RedirectUris.Add(new Uri($"{frontendBaseUrl.TrimEnd('/')}/auth/callback-popup.html"));
        ...
        newDescriptor.RedirectUris.Add(new Uri($"{frontendBaseUrl.TrimEnd('/')}/auth/callback-popup.html"));
        ...
        IOpenIddictApplicationManager appManager)
    {
        ...
        var descriptor = new OpenIddictApplicationDescriptor
        {
            ...
            DisplayName = "Application par défaut",
        ...
        var oAuthClient = new OAuthClient
        {
            ...
            ClientName = "Application par défaut",
            RedirectUris = "[]",
